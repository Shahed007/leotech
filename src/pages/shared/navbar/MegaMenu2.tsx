...
const MegaMenu2: React.FC<MegaProps> = ({ mega }) => {
  return (
    <div className="absolute top-6 duration-500 h-0 overflow-hidden  group-hover:h-auto group-hover:overflow-auto right-0 w-[770px] bg-transparent transition-all ease-in-out">
